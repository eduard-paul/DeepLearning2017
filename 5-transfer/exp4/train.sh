...
# Test FCN
echo "Test FCN"
$TOOLS/caffe test -gpu=0 -model=$WORK_DIR/$EXP_DIR/resnet-18_asl.prototxt -solver=$WORK_DIR/$EXP_DIR/solver.prototxt -weights="$SNAPSHOT_DIR/lab5_exp4_iter_5000.caffemodel" -iterations=62 $@
